...
<html style="height: 100%; width: 100%;">
  ...
  <!-- Global site tag (gtag.js) - Google Ads: 825554032 -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-825554032"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'AW-825554032');
  </script>
  </head>
  <script>
  ...
  function gtag_report_conversion(url) {
    ...
    gtag('event', 'conversion', {
        'send_to': 'AW-825554032/RcZcCLqVu7EBEPDo04kD',
